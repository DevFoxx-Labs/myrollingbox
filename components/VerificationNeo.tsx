...
export default function VerificationNeo() {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    if (verifyId.toLowerCase().includes("mrb") || verifyId.length >= 4) {
      setVerifyStatus({
        valid: true,
        message: "Verified Original MyRollingBox Booking / Partner!",
  ...
  return (
    <section id="fake-warning" className="py-16 bg-[#0B0E17] border-y border-amber-500/20 text-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="glass-neo rounded-3xl p-6 sm:p-10 border border-amber-500/30 shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-medium">
                Unscrupulous operators often register fake websites with names similar to <strong className="text-white font-bold">MyRollingBox</strong>, Agarwal, or Om Packers to quote low prices and demand ransom money. Verify credentials before making any payments.
              </p>
            ...
            <div className="lg:col-span-5 bg-slate-950/90 rounded-2xl p-6 border border-slate-800 shadow-xl">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-base font-extrabold text-white">Verification Scanner</h3>
              </div>
              ...
              <form onSubmit={handleVerify} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-700 rounded-xl py-3 px-3.5 pr-10 text-xs font-bold text-white placeholder-slate-500 focus:border-amber-400 focus:outline-none"
                  />
                ...
                <button
                  type="submit"
                  className="w-full btn-neon-amber py-3 text-xs font-black flex items-center justify-center gap-1.5 cursor-pointer shadow-md"
                >
