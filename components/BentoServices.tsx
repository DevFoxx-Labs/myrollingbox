...
export default function BentoServices({ onOpenBookingModal }: BentoServicesProps) {
  const services = [
    {
      id: "home-relocation",
    ...
    },
    {
      ...
      colSpan: "lg:col-span-4",
      featured: false,
      badge: "7-Layer Protection",
    },
  ];

  return (
    <section id="services" className="py-20 bg-[#090D16] text-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div className="space-y-3 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-600/20 border border-rose-500/30 text-rose-400 text-xs font-bold uppercase tracking-wider">
          ...
          <button
            ...
            className="btn-21-glass px-6 py-3 text-xs font-bold flex items-center gap-2 shrink-0 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {services.map((svc) => {
            ...
            return (
              <div
                key={svc.id}
                className={`${svc.colSpan} glass-panel rounded-3xl overflow-hidden border border-slate-800 hover:border-rose-500/50 transition-all duration-300 group flex flex-col justify-between relative`}
              >
                ...
                <div className="relative h-64 sm:h-72 w-full overflow-hidden bg-slate-900">
                  ...
                  {/* Badge */}
                  <span className="absolute top-4 right-4 bg-slate-950/80 backdrop-blur-md border border-slate-700 text-rose-400 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-wider">
                    {svc.badge}
                  </span>

                  {/* Icon */}
                  <div className="absolute top-4 left-4 w-10 h-10 rounded-2xl bg-rose-600/30 backdrop-blur-md border border-rose-500/40 text-white flex items-center justify-center font-extrabold shadow-lg">
                ...
                <div className="p-6 sm:p-8 space-y-3 relative z-10 -mt-10">
                  ...
                  <div className="pt-3 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="btn-21-red px-4 py-2 text-[11px] font-black cursor-pointer shadow-md"
                    >
